...
{
    const PROGRAMS = [
        ['title' => 'Stranger Things', 'synopsis' => 'À Hawkins, dans l\'Indiana, en 1983. Lorsque Will Byers disparaît de son domicile, ses amis se lancent dans une recherche semée d\'embûches pour le retrouver. Dans leur quête de réponses, les garçons rencontrent une étrange jeune fille en fuite. Les garçons se lient d\'amitié avec la demoiselle tatouée du chiffre « 11 » sur son poignet et au crâne rasé et découvrent petit à petit les détails sur son inquiétante situation. Elle est peut-être la clé de tous les mystères qui se cachent dans cette petite ville en apparence tranquille…', 'poster' => '/Stranger-things.png', 'category' => 'category_Fantastique', 'country' => 'USA', 'year' => '2016'],
        ['title' => 'Vikings', 'synopsis' => 'Scandinavie, fin du VIII° siècle. Ragnar Lothbrok, un guerrier viking, est avide de nouvelles conquêtes. Il se met en tête d\'explorer l\'Ouest par la mer.', 'poster' => '/Vikings.png', 'category' =>'category_Action', 'country' => 'USA', 'year' => '2016'],
        ...
        Kirito décide alors de partir à la conquête du jeu en solo, avec pour avantage le fait de faire partie des 1 000 ex-bêta-testeurs, mais arrivera-t-il à terminer les 99 donjons et leurs boss ?','poster' => '/SAO.png', 'category' =>'category_Animation', 'country' => 'USA', 'year' => '2013'],
        ['title' => 'Buffy contre les vampires', 'synopsis' => 'Buffy Summers aspire à une vie simple et épanouie auprès de sa famille et de ses amis. Mais les démons qui rôdent à Sunnydale lui rappellent sans cesse qu\'elle doit faire face à ses responsabilités de Tueuse.','poster' => '/Buffy.png', 'category' =>'category_Fantastique', 'country' => 'USA', 'year' => '2016'],
