...
{
    const PROGRAM = [
        ['title' => 'Stranger Things', 'synopsis' => 'À Hawkins, dans l\'Indiana, en 1983. Lorsque Will Byers disparaît de son domicile, ses amis se lancent dans une recherche semée d\'embûches pour le retrouver. Dans leur quête de réponses, les garçons rencontrent une étrange jeune fille en fuite. Les garçons se lient d\'amitié avec la demoiselle tatouée du chiffre « 11 » sur son poignet et au crâne rasé et découvrent petit à petit les détails sur son inquiétante situation. Elle est peut-être la clé de tous les mystères qui se cachent dans cette petite ville en apparence tranquille…', 'category' => 'category_Fantastique'],
        ['title' => ' Vikings', 'synopsis' => 'Scandinavie, fin du VIII° siècle. Ragnar Lothbrok, un guerrier viking, est avide de nouvelles conquêtes. Il se met en tête d\'explorer l\'Ouest par la mer.', 'category' => 'category_Action'],
        ...
        Kirito décide alors de partir à la conquête du jeu en solo, avec pour avantage le fait de faire partie des 1 000 ex-bêta-testeurs, mais arrivera-t-il à terminer les 99 donjons et leurs boss ?', 'category' => 'category_Animation'],
        ['title' => 'Buffy contre les vampires', 'synopsis' => 'Buffy Summers aspire à une vie simple et épanouie auprès de sa famille et de ses amis. Mais les démons qui rôdent à Sunnydale lui rappellent sans cesse qu\'elle doit faire face à ses responsabilités de Tueuse.', 'category' => 'category_Fantastique'],
        ['title' => 'Avatar : Le dernier maître de l\'air', 'synopsis' => 'Ang est un jeune Maître de l\'Air, mais c\'est surtout l\'Avatar, un être unique qui maîtrise tous les éléments - Feu, Air, Eau et Terre. Lors d\'un terrible orage, il sombre dans la mer et hiberne grâce à ses pouvoirs d\'Avatar, pour se réveiller un siècle plus tard dans un monde tyrannisé par la puissante Nation du Feu et où il est le dernier représentant de son peuple. Aidé de ses deux amis de la Tribu de l\'Eau, Ang va devoir réveiller l\'Avatar en lui, apprendre à contrôler tous les éléments et se battre contre la menace que les Maîtres du Feu font peser sur le monde', 'category' => 'category_Animation'],
        ...
        ['title' => '  Marvel\'s Daredevil', 'synopsis' => 'Avocat luttant contre l\'injustice et aveugle depuis l\'enfance, Matt Murdock fait place au super-héros Daredevil lorsque la nuit tombe sur les rues de New York.', 'category' => 'category_Action'],
        ['title' => '  Spartacus', 'synopsis' => 'Puissant guerrier thrace trahi par un légat romain, Spartacus est réduit en esclavage à Capoue, et contraint de devenir gladiateur s’il veut revoir sa femme.', 'category' => 'category_Action'],
